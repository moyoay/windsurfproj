...
function drawLlama(ctx, x, y, size = 18, color = '#7a5c3a') {
...
export default function RunnerGame() {
  ...
  const llamaRef = useRef({ x: 80, y: GROUND_Y, vy: 0, size: 20, onGround: true })
  ...
  useEffect(() => {
    ...
    function loop(time) {
      ...
      ctx.fillText(`Best: ${Math.max(high, score)}`, 12, 40)
